...
HD_PWD='C:/Users/brick/OneDrive/Documents/ECE3300L/Lab 3/Lab 3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_16x1Lab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux_16x1Lab.tcl -notrace
