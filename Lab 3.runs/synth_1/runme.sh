...
HD_PWD='C:/Users/brick/OneDrive/Documents/ECE3300L/Lab 3/Lab 3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_16x1Lab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_16x1Lab.tcl
