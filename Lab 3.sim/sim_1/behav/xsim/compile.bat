...
REM
REM Generated by Vivado on Wed Jul 01 17:27:45 -0700 2026
...
echo "xvlog --incr --relax -prj Lab3TestBench_vlog.prj"
call xvlog  --incr --relax -prj Lab3TestBench_vlog.prj -log xvlog.log
